...
namespace Gleed2D.InGame.Interpolation
{
    ...
    public sealed class Tweener
    {
		...
		//public static TweeningFunction CreateTweeningFunction(TweenCreationSettings tweenCreationSettings)
		//{
		//    return (TweeningFunction)(Delegate.CreateDelegate(typeof(TweeningFunction), tweenCreationSettings.Type, tweenCreationSettings.Easing.ToString( )) ) ;
		//}
